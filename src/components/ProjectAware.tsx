...
const Project: React.FC<ProjectProps> = ({
  ...
  return (
    <div className="relative group max-w-3xl mx-auto mt-8 overflow-hidden border shadow-2xl hover:shadow-2xl transition-shadow duration-300">
      ...
      >
        <h2 className="text-2xl font-bold uppercase group-hover:text-blue-900 dark:group-hover:text-cyan-100">
          {title}
        </h2>
        ...
        <div className="group mt-4">
          <div className="flex flex-wrap justify-center gap-10 text-3xl">
